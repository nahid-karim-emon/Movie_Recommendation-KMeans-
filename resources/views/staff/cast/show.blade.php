...
@section('title', ' Cast Details | Staff Dashboard')
             ...
             <div class="row">
              ...
              <div class="row">
                <div class="col-sm-3 float-left">
                  <a href="{{ route('staff.cast.edit',$data->id) }}"><button type="button" class="btn btn-primary">Edit Cast</button></a>
                </div>
                <div class="col-sm-3 float-right">
                  @if ($data->status==0)
                  <a href="{{ route('staff.cast.edit',$data->id) }}"><button type="button" class="btn btn-warning">Make Active</button></a>
                  @else
                  <a href="{{ route('staff.cast.edit',$data->id) }}"><button type="button" class="btn btn-danger">Make Disable</button></a>
                  @endif
