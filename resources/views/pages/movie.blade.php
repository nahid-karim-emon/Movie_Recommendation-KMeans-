  ...
  <div class="container-xl">
   ...
   <div class="carousel-inner">
     <div class="carousel-item active">
        <div class="events_1i row justify-content-center gap-2">
      ...
      <div class="movie-card mb-4">
        <div class="events_1i1 clearfix position-relative">
          <div class="events_1i1i clearfix">
           <a href="{{ route('movie.show',$movie->id) }}"><img width="100%" height="350px" src="{{$movie->photo ? asset('storage/'.$movie->photo) : asset('images/productioncompany.jpg')}}" alt="abc" ></a>
          </div>
         ...
         <div class="events_1i2 clearfix p-3 bg-white">
   ...
   <div class="movie-card mb-4">
    <div class="events_1i1 clearfix position-relative">
     ...
     <div class="events_1i2 clearfix p-3 pt-4 pb-4 bg-white">
      <h5 class="text-uppercase "><a href="{{ route('movie.show',$movie->id) }}">{{ $movie->title }}</a></h5>
      <h6>@foreach ($movie->MovieGenre as $MovieGenre)
       {{ $MovieGenre->genre->title }}
       @endforeach </h6>
