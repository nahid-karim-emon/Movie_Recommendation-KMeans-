...
class ProductionCompanyController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.pcompany.index', ['data' => $data]);
    }
    ...
    public function create()
    {
        //
        $genres = Genre::all();
        return view('admin.pcompany.create', ['genres' => $genres]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $data->save();
        //Data Saved
        return redirect()->route('admin.pcompany.index')->with('success', 'Production Company Added Successfully!');
    }
    ...
    public function show(string $id)
    {
        ...
        return view('admin.pcompany.show', ['data' => $data]);
    }
    ...
    public function edit(string $id)
    {
        ...
        $genres = Genre::all();
        $data = ProductionCompany::find($id);
        return view('admin.pcompany.edit', ['data' => $data, 'genres' => $genres]);
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $data->save();
        //Data Saved
        return redirect()->route('admin.pcompany.index')->with('success', 'Production Company Updated Successfully!');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('admin.pcompany.index')->with('danger', 'Production Company has been deleted Successfully!');
    }
}
