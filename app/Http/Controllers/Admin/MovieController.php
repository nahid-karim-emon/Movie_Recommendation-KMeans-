...
class MovieController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.movie.index', ['data' => $data, 'genres' => $genres, 'languages' => $languages, 'countries' => $countries, 'pcompanys' => $pcompanys]);
    }
    ...
    public function indexPCompany(Request $request)
    {
        $data = MoviePcompany::all()->where('pcompany_id', $request->id);
        $pcompany = ProductionCompany::find($request->id);
        $pcompanys = ProductionCompany::all();
        return view('admin.movie.pcompany', ['data' => $data, 'pcompany' => $pcompany, 'pcompanys' => $pcompanys]);
    }
    /**
    ...
    public function create()
    {
        ...
        $countries = Country::all();
        return view('admin.movie.create', ['genres' => $genres, 'casts' => $casts, 'languages' => $languages, 'pcompanys' => $pcompanys, 'directors' => $directors, 'countries' => $countries]);
    }
    ...
    public function show(string $id)
    {
        ...
        return view('admin.movie.show', ['data' => $data, 'MovieGenredata' => $MovieGenredata, 'MovieCountryData' => $MovieCountryData, 'MovieCastdata' => $MovieCastdata, 'MovieDirectordata' => $MovieDirectordata, 'MovieLanguagedata' => $MovieLanguagedata, 'MoviePcompanydata' => $MoviePcompanydata, 'MovieRatingData' => $MovieRatingData]);
    }
    ...
    public function edit(string $id)
    {
        ...
        $directors = Director::all();
        $countries = Country::all();
        return view('admin.movie.edit', ['data' => $data, 'genres' => $genres, 'casts' => $casts, 'languages' => $languages, 'pcompanys' => $pcompanys, 'directors' => $directors, 'countries' => $countries]);
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('admin.movie.index')->with('danger', 'Movie has been deleted and Related Data Removed Successfully!');
    }
    ...
    public function rating(string $id)
    {
        ...
        $data = Movie::find($id);
        $MovieRatingData = MovieRating::all()->where('movie_id', '=', $id);
        return view('admin.movie.rating', ['data' => $data, 'MovieRatingData' => $MovieRatingData]);
    }
    public function ratingUpdate(Request $request, string $id)
    {
        ...
        return redirect()->route('admin.movie.index')->with('success', 'Movie Rating Updated Successfully!');
    }
}
